...
def send_message(object,message):
    ...
    print(msg)
send_whatsapp_message = lambda msg : send_message(twilioObj,msg)


client = Client(os.getenv("BINANCE_API_KEY"),
                os.getenv("BINANCE_API_SECRET"), tld="com")
...
if len(orders)==1:
    ...
    send_whatsapp_message("!important. 2 unfilled orders are there. Killing instance. ")
    sys.exit()
        ...
        if start < float(eachTrade["p"]):
                ...
                if temp>lastBuy and brought>=qty:
                    ...
                    if choice == "y":
                        order1 = client.order_limit_sell(
                            ...
                            quantity=qty,
                            price=temp)
                        send_whatsapp_message("🏦 SELLING CYYPTO\n"+return_order_details(order1))
            ...
            if l >= 20:
                ...
                if choice == "y":
                    ...
                    l=0
                    print(order1)
                    send_whatsapp_message("💳 BUYING CRYPTO\n"+return_order_details(order1))
                    time.sleep(3)
                    startTime  = int(time.time())
                    ...
                    if becauseOfTime:
                        ...
                        send_whatsapp_message("☠️ CANCELLED ORDER DUE TO TIMEOUT\n"+return_order_details(order1))
                        return 
                    send_whatsapp_message("✅ BUYING CRYPTO DONE\n"+return_order_details(order1))
